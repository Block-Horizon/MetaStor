      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              href="/"
              className="text-zinc-300 hover:text-indigo-400 px-3 py-2 rounded-md text-sm font-medium"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              href="/profile"
              className="text-zinc-300 hover:text-indigo-400 px-3 py-2 rounded-md text-sm font-medium flex items-center"
            >
              <LuUser className="mr-1 h-4 w-4" /> Profile
            </Link>
            <WalletConnectButton />
          </div>
        ...
        {isOpen && (
          <div className="md:hidden bg-zinc-950/95 rounded-b-xl shadow-lg border-t border-zinc-800 py-2">
            <div className="px-2 space-y-1">
              <Link
                href="/"
                className="block text-zinc-300 hover:text-indigo-400 px-3 py-2 rounded-md text-base font-medium"
